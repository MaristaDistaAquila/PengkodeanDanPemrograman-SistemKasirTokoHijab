...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=barang'>Tabel
                    Produk Hijab <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-upload"></i> Hijab Terjual</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=laporan'>Tabel
                    laporan Penjualan Hijab <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
